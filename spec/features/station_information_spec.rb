...
# describe 'visitor viewing station info' do
#   it 'station show page', :vcr do
#     visit station_path(1)
#     expect(page).to have_text("Y Not Wednesday Farmers station at Town Center")
#     expect(page).to have_text("201 station Street")
...
#   describe 'visitor adding review to station' do
#     it "can add a review and then see it on the station page", :vcr do
#       visit station_path(1)
